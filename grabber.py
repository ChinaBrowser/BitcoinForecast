...
while True:
    ...
    f.write("{},{},{},{},{},{},{},{},{},{},".format(poloniex_data["USDT_BTC"]["last"],poloniex_data["USDT_BTC"]["baseVolume"],data["market_cap_usd"],data["total_supply"],data["total_supply"],data["percent_change_1h"],data["percent_change_24h"],data["percent_change_7d"],poloniex_chart2["volume"],poloniex_chart2["weightedAverage"]))
